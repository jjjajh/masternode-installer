...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='thatsthelabor.conf'
CONFIGFOLDER='/root/.thatsthelabor'
COIN_DAEMON='thatsthelabord'
COIN_CLI='thatsthelabor-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/jjjajh/ttl-core/releases/download/v1/ttl-linux-daemon.tar.gz'
...
function download_node() {
  ...
  compile_error
  cp thatsthelabor* /usr/local/bin
  compile_error
...
#Nodes
addnode=161.35.63.12
addnode=167.99.13.80
EOF
}
